...
class UserAddress2 extends StatefulWidget {
  final String? userId;
  UserAddress2({Key? key, this.userId}) : super(key: key);

  @override
  State<UserAddress2> createState() => _UserAddress2State();
}

class _UserAddress2State extends State<UserAddress2> {
  ...
  String url = "https://reliance-appropriations-capital-information.trycloudflare.com/add-address/";
  var tokenn;
  ...
  void RegisterUserData(
    ...
    try {
      ...
      if (response.statusCode == 201) {
        ...
        Navigator.push(
            context, MaterialPageRoute(builder: (context) => UserAddress2()));
