...
class Bogo_Eligible_Products extends StatefulWidget {
  final String? user_id; // Receive user_id as a parameter

  const Bogo_Eligible_Products({Key? key, this.user_id}) : super(key: key);

  @override
  State<Bogo_Eligible_Products> createState() => _Bogo_Eligible_ProductsState();
}

class _Bogo_Eligible_ProductsState extends State<Bogo_Eligible_Products> {
