...
class _CartState extends State<Cart> {
  ...
  var CartUrl = "https://reliance-appropriations-capital-information.trycloudflare.com/cart-products/";
  final String productsurl =
      "https://reliance-appropriations-capital-information.trycloudflare.com/products/";

  final quantityincrementurl =
      "https://reliance-appropriations-capital-information.trycloudflare.com/cart/increment/";

  final quantitydecrementurl =
      "https://reliance-appropriations-capital-information.trycloudflare.com/cart/decrement/";

  final deletecarturl =
      "https://reliance-appropriations-capital-information.trycloudflare.com/cart-delete/";
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        for (var item in data) {
          String imageUrl ="https://reliance-appropriations-capital-information.trycloudflare.com/${item['image']}";
        ...
        if (offerType == "BUY 1 GET 1") {
            ...
            while (freeItems > 0) {
                ...
                if (freeItems >= dQuantity) {
                    ...
                    freeItems -= dQuantity;
                    print("Total after reduction: $totalPrice, remaining free items: $freeItems");
                    ...
                    for (int j = 0; j < cartProducts.length; j++) {
                        ...
                        if ((nextLeastPrice == null || price < nextLeastPrice) &&
                            (nextOfferType == "BUY 1 GET 1" || nextOfferType == "BUY 2 GET 1") &&
                            price > leastPrice!) {
                    ...
                    if (nextLeastPrice == null) break; // No more lower priced products
        ...
        children: [
                  ...
                  child: Container(
                    ...
                    child: Row(
                      children: [
                       ...
                       if (selectedOption == 'Option 1' &&
                          (cartProducts[index]['offer_type'] == 'BUY 1 GET 1' ||
                          cartProducts[index]['offer_type'] == 'BUY 2 GET 1')) 
                                  Padding(
          ...
          Padding(
            ...
            child: InkWell(
              onTap: () {
                Navigator.push(
                    context, MaterialPageRoute(builder: (context) => Select_Delivery_Address()));
              },
              child: Container(
                height: 50,
