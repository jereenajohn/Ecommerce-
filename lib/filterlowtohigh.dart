...
class _lowtohighpageState extends State<lowtohighpage> {
  ...
  final String hightolow = "https://sample-houston-cet-travel.trycloudflare.com//high-products/";
  final String wishlisturl = "https://sample-houston-cet-travel.trycloudflare.com//whishlist/";
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        for (var productData in searchData) {
          String imageUrl = "https://sample-houston-cet-travel.trycloudflare.com/${productData['image']}";
          searchList.add({
            'id': productData['id'],
