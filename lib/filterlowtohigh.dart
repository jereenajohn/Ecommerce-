...
class lowtohighpage extends StatefulWidget {
  final List<Map<String, dynamic>> result;
  final int SubcatId;

  lowtohighpage({Key? key, required this.result, required this.SubcatId}) : super(key: key);

  @override
  State<lowtohighpage> createState() => _lowtohighpageState();
}

class _lowtohighpageState extends State<lowtohighpage> {
  ...
  final String hightolow = "https://papua-violation-assistance-hearts.trycloudflare.com//high-products/";
  final String wishlisturl = "https://papua-violation-assistance-hearts.trycloudflare.com//whishlist/";
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        for (var productData in searchData) {
          String imageUrl = "https://papua-violation-assistance-hearts.trycloudflare.com/${productData['image']}";
          searchList.add({
            'id': productData['id'],
        ...
        setState(() {
          ...
          print('HightoLow result: $hightolowresult');
        });
      } else {
                        ...
                        child: Column(
                          children: [
                            ListTile(
                              ...
                              onTap: () async {
                                await HightoLow(widget.SubcatId);
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
                            ...
                            ListTile(
                              ...
                              onTap: () async {
                                // Implement Low to High sorting if needed
                              },
                            ),
                          ],
                        ),
