...
class _SubcategoryProductsPageState extends State<SubcategoryProductsPage> {
  ...
  final String productsUrl =
      "https://latina-warcraft-welsh-arcade.trycloudflare.com//subcategory/";
  ...
  final String lowtohigh =
      "https://latina-warcraft-welsh-arcade.trycloudflare.com//low-products/";
  final String hightolow =
      "https://latina-warcraft-welsh-arcade.trycloudflare.com//high-products/";

  final String pricefilter =
      "https://latina-warcraft-welsh-arcade.trycloudflare.com/filtered-products/";
    ...
    if (response.statusCode == 200) {
      ...
      List<Map<String, dynamic>> offersList = [];
        ...
        for (var pfilter in pfill) {
          String imageUrl =
              "https://latina-warcraft-welsh-arcade.trycloudflare.com${pfilter['image']}";
          offersList.add({
            'id': pfilter['id'],
            'name': pfilter['name'],
